...
按 [AGENT_LEARNING_PLAN.md](../AGENT_LEARNING_PLAN.md) 每周日在此目录写复盘，例如 `week-1.md`。
...
- **Token**：计费与上下文单位；本次实验 input 约 14–22，output 约 18–40
- **Temperature**：0 更稳定，1.2 表述更展开；同一问题两者语义接近但措辞不同
